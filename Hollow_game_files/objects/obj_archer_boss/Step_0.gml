...
if(place_meeting(x+1, y, obj_geometry_no_climb) || place_meeting(x-1, y, obj_geometry_no_climb))
{
...
switch(archer_state)
{
	...
	case archer_AI_boss_states.run_away:
	{
		...
		else
		{
			...
			else if(place_meeting(x+1, y, obj_geometry_no_climb) || place_meeting(x-1, y, obj_geometry_no_climb))
			{
				archer_state = archer_AI_boss_states.climb_stop;
			}
			/*
